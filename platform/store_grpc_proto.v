...
pub mut:
	store string
	query []u8
	// comp — the QUOTED planar comprehension's source text (stream-2 L99,
	// store.md §6.2). query/comp are mutually exclusive; a request with
