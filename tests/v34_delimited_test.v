...
// Phase 7.67 — delimited V core (ADR 0001) smoke tests. The fuller
...
fn test_parse_csv_quoted_string_stays_string() {
	...
	// explicit "this is a string" signal per ADR 0001 D5.
	csv_in := 'name,age\nalice,"30"\nbob,"25"\n'
	out := cx.from_csv(csv_in) or { panic(err) }
...
fn test_roundtrip_table() {
  ...
  bob 25 false
	...
	// is not recoverable from CSV per ADR 0001 D7. Type narrowing
