...
fn time_datetime_node(v string) cx.Node {
...
fn (dt TDateTime) instant_ns() i64 {
...
fn dt_from_instant(instant_ns i64, offset i64) TDateTime {
...
fn (dt TDateTime) datetime_string() string {
...
fn decode_datetime(n cx.Node) ?TDateTime {
	s := time_arg_str(n) or { return none }
...
fn time_stdlib_builtin(name string, args []cx.Node) ?cx.Node {
